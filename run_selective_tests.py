...
def run_query_explain(cursor, date_filter):
    query = f"""
...
with connection.cursor() as cursor:
    ...
    nodes_before, time_before, raw_before = run_query_explain(cursor, '2026-05-07')
    ...
    # 4. Run query AFTER optimization (Shifting date to '2026-05-08' to ensure cold cache equivalent)
    print("Running AFTER optimization (shifting date to '2026-05-08' for cold cache)...")
    nodes_after, time_after, raw_after = run_query_explain(cursor, '2026-05-08')
